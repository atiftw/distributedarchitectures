...
object ReplicationStrategies {
  ...
  trait ReplicaAssignmentStrategy {

    def assignReplicasToBrokers(brokerList: List[Int], nPartitions: Int, replicationFactor: Int): Set[PartitionReplicas]

  }

  object DefaultReplicaAssignmentStrategy extends ReplicaAssignmentStrategy {
