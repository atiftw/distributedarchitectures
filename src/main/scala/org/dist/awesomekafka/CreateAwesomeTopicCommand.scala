...
case class ReplicaAssignmentStrategy()
class CreateAwesomeTopicCommand(zookeeperClient:AwesomeZookeeperClient, partitionAssigner:ReplicaAssignmentStrategy = null) {
  val rand = new Random
